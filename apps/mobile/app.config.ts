...
const config: ExpoConfig = {
  ...
  android: {
    ...
    googleServicesFile: repoEnv.T3CODE_ANDROID_GOOGLE_SERVICES_FILE ?? "./google-services.json",
  ...
  plugins: [
    ...
    [
      "expo-audio",
      {
        microphonePermission: "Allow S5 Code to use your microphone for voice input.",
