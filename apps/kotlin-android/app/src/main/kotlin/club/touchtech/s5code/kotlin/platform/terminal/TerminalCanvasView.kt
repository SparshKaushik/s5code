...
internal class TerminalCanvasView(context: Context) : View(context) {
  ...
  override fun onDraw(canvas: Canvas) {
    ...
    canvas.withClip(
      ...
      drawTerminalGrid(canvas, currentFrame)
    }
    drawSelectionHandles(canvas)
  }

  @Suppress("NestedBlockDepth", "ComplexCondition")
  private fun drawTerminalGrid(canvas: Canvas, currentFrame: TerminalFrame) {
  ...
  override fun onTouchEvent(event: MotionEvent): Boolean {
    ...
    return when {
      ...
      // The gesture detector's single-tap callback invokes performClick; keeping
      // click detection there avoids firing while a drag or selection is active.
