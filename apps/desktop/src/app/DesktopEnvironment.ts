...
> {
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "club.touchtech.s5code.dev" : "club.touchtech.s5code",
    ),
    linuxDesktopEntryName: isDevelopment ? "s5code-dev.desktop" : "s5code.desktop",
