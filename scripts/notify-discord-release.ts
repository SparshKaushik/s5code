  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new S5 Code prerelease is available for nightly testers."
          : "A new S5 Code latest release is available.",
...
).pipe(Command.withDescription("Post a S5 Code release announcement to Discord."));
