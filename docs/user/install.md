...
S5 Code runs coding agents on your computer and lets you control them from its
...
This starts the S5 Code server on your machine and opens the local web app. Run
...
available version. **Update now** appears only when S5 Code can tell which
...
base URL. Mark secret values as sensitive; after saving, S5 Code does not display
...
- [Keeping S5 Code in sync](./updating.md): update the app and connected servers.
