...
On a Linux host, S5 Code can run as a background service for your user. It starts when the machine
...
The systemd unit runs a small stable launcher. Exact S5 Code versions are installed separately, so
